...
class gridtest_review(GridTest):
    ...
    def test_update_profile(self,cap):
    ...
    def test_run_MyTest(self):
        ...
        if self.grid:
            self.browser.test_run_grid_parallel(self.test_update_profile)
        else:
            self.browser.test_run_grid_serial(self.test_update_profile)
